...
class _AlumniProfileEditPageState extends State<AlumniProfileEditPage> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      if (_currentStatus == 'studying' ||
          _currentStatus == 'studying_working') {
  ...
  Widget build(BuildContext context) {
    ...
    final showStudyingFields =
        _currentStatus == 'studying' || _currentStatus == 'studying_working';
    final showWorkingFields =
        _currentStatus == 'working' || _currentStatus == 'studying_working';
                ...
                children: [
                  if (widget.isMandatory) ...[
                    Container(
                      ...
                      child: const Text(
                        'Akun Anda sudah diverifikasi. Lengkapi data berikut agar seluruh layanan alumni dapat digunakan.',
                        style: TextStyle(
                          fontSize: 13.5,
                          height: 1.45,
                    ...
                    children: [
                      DropdownButtonFormField<String>(
                        ...
                        items: const [
                          ...
                          DropdownMenuItem(
                            value: 'studying',
                            child: Text('Kuliah / Pendidikan Lanjut'),
                          ),
                          DropdownMenuItem(
                            value: 'working',
                            child: Text('Bekerja'),
                          ...
                          DropdownMenuItem(
                            value: 'studying_working',
                            child: Text('Kuliah Sambil Bekerja'),
                          ),
                          DropdownMenuItem(
                            value: 'entrepreneur',
